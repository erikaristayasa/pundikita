...
class ProfessionCalculate extends StatefulWidget {
  const ProfessionCalculate({Key? key}) : super(key: key);

  @override
  State<ProfessionCalculate> createState() => _ProfessionCalculateState();
}

class _ProfessionCalculateState extends State<ProfessionCalculate> {
