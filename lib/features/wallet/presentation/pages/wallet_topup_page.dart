...
import '../bloc/topup/wallet_topup_bloc.dart';
import 'wallet_topup_result_page.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => locator<WalletTopupBloc>()),
      ],
      child: LoaderOverlay(
        child: Scaffold(
                    ...
                    child: BlocBuilder<NominalCubit, int?>(builder: (context, state) {
                      return Column(
                        ...
                        children: [
                          ...
                          mediumVerticalSpacing(),
                          BlocListener<WalletTopupBloc, WalletTopupState>(
                            listener: (context, state) {
                              if (state is WalletTopupLoading) {
                                context.loaderOverlay.show();
                              } else if (state is WalletTopupFailed) {
                                ...
                                Navigator.popAndPushNamed(
                                  ...
                                  arguments: WalletTopUpResultPageRouteArguments(result: state.result),
                                );
                              }
                            },
                            child: BlocBuilder<PaymentMethodCubit, PaymentMethodState>(
                              builder: (context, method) {
                                return RoundedButton(
                                  ...
                                  onTap: () {
                                    final payment = method as PaymentMethodSelected;
                                    context.read<WalletTopupBloc>().add(DoTopUp(
